        ...
        try {
           ...
           if(message!=null){
                    if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                        ...
                        notificationUtils.playNotificationSound();
                        if (pars[2] != null) {
                         resultIntent = new Intent(getApplicationContext(), GetRide.class);
                        resultIntent.putExtra("Vehicle", pars[2]);
                        resultIntent.putExtra("mylat", Double.valueOf(pars[0]));
                        resultIntent.putExtra("mylong", Double.valueOf(pars[1]));
