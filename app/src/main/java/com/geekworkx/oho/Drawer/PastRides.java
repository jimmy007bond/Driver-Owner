...
import com.geekworkx.oho.Model.Past;
...
public class PastRides extends AppCompatActivity {
    ...
    private ArrayList<Past> mItems=new ArrayList<Past>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(PastRides.this, Ride_later_dates.class);
                        ...
                        for (int i = 0; i < later1.length(); i++) {
                            ...
                            if (!c.isNull("User_ID")  ) {
                                ...
                                for (int j = 0; j < driver.length(); j++) {
                                    ...
                                    if ( UNIQUEID.matches(c.getString("Unique_Ride_Code"))) {
            ...
            if (mItems.size() != 0) {
                ...
                if(mItems.get(0).getVehicle(0)!=null &&
                    ...
                    if (mItems.get(0).getVehicle(0).contains("SEDAN")) {
                        ...
                        PastCar.setImageBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_suvv));
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if(dataSnapshot.getChildrenCount()!=0) {
                ...
                if (dataSnapshot.child("Bill").getValue() != null &&
                        ...
                        total_km_cost.setText("\u20B9 " +dft.format(Double.parseDouble( (String) dataSnapshot.child("Cost").getValue())));
    ...
    public void onBackPressed() {
        ...
        Intent o = new Intent(PastRides.this,Ride_later_dates.class);
